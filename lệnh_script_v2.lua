...
local Window = Fluent:CreateWindow({
    Title = "blox-fruit-kousei [PREMIUM",
    SubTitle = "by obii kousei",
    TabWidth = 160,
...
spawn(function()
    while wait() do
        ...
        if game:GetService("Lighting").Sky.MoonTextureId=="http://www.132505802597836=132505802597836" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.132505802597836=132505802597836" then
            wait(2.0)
        elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.132505802597836=132505802597836" then
            Hop()
            Fluent:Notify({
                Title = "",
